  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: [
          Stack(
            children: [
              Image.network('${API.imgPath}${topRated.backdropPath}'),
              Positioned(
                  left: 20,
                  top: 30,
                  child: CardWidget(
          ...
          Row(
            children: [
              const SizedBox(width: 20),
              Text(topRated.releaseDate ?? '', style: TextStyles.decription),
              const SizedBox(width: 120),
              CardWidget(
                  widget: Center(
                    child: Text('Action', style: TextStyles.decription),
                  ),
                  radius: 18,
                  width: 72,
                  height: 30,
              ...
              CardWidget(
                  widget: Center(
                    child: Text('Sci-Fi', style: TextStyles.decription),
                  ),
                  radius: 18,
                  width: 72,
                  height: 30,
          ...
          Row(
            children: [
              const SizedBox(width: 20),
              Text('Cast & Drew', style: TextStyles.lato500Size19),
              const Spacer(),
              BlocProvider(
